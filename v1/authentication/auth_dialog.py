...
if __name__ == '__main__':
    # Важно: для корректной работы с базой данных, она должна быть доступна
    # и .env файл должен быть настроен правильно в корне проекта.
    # Перед запуском этого теста, убедитесь, что init_db() вызывается где-то,
    # или вызовите его здесь для создания таблиц, если они еще не созданы.
    # try:
